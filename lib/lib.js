...
// @ts-ignore
let {Analyzer, link} = require("./analyzer")
// @ts-ignore
let Analyzer2 = require("./analyzer2").Analyzer
...
function handleModule(name) {
  ...
  let a2 = new Analyzer2(g_ruleMap, source)
  a2.analyze(ast)

  console.log(JSON.stringify(a2.module, null, 2))

  return {
    src: source,
    ast: ast,
    ctx: analyzer.rootScope,
  }
}
